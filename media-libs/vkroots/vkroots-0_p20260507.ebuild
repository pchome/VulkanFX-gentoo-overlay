...
COMMIT="ee76e620798612c52fb8dcc32a1058a0a3538930"
DESCRIPTION="Simple framework for writing Vulkan layers"
HOMEPAGE="https://github.com/misyltoad/vkroots"
SRC_URI="https://github.com/misyltoad/${PN}/archive/${COMMIT}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/${PN}-${COMMIT}"
